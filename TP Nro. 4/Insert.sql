...
('Efectivo', 400000, 'Supervielle', '2010-09-02', 16478532),
('Tarjeta', 300000, 'Patagonia', '2018-11-22', 46214695),
('Tarjeta', 600000, 'Hipotecado', '2015-04-15', 16794652),
('Efectivo', 200000, 'Municipal', '2021-07-08', 34899665),
('Tarjeta', 550000, 'Santander', '2020-04-28', 24683157),
('Efectivo', 100000, 'Corrientes', '2022-09-13', 31648289),
('Efectivo', 300000, 'Brubank', '2012-02-28', 47589631),
('Tarjeta', 400000, 'Bibank', '2023-12-01', 24683157),
('Efectivo', 600000, 'Mariva', '2019-05-23', 16478532);
